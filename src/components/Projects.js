...
import ReservationApp from "../assets/img/mockup-showcase.png";
...
export const Projects = () => {
  const projects = [
    ...
    {
      title: "Restaurant Reservation Website Design",
      category: "UI/UX",
      description: "Design & Development",
    ...
    {
      title: "Restaurant Reservation App Design",
      category: "UI/UX",
      description: "Design",
      imgUrl: ReservationApp,
      link: " https://restaurant-reservation-mobile-app-case-study.vercel.app/",
    },
            ...
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  <h2>Projects</h2>
                  <p>
                    Explore my portfolio featuring a blend of UI/UX design and
